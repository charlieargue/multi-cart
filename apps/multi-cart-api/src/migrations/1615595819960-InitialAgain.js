...
var InitialAgain1615595819960 = /** @class */ (function () {
    function InitialAgain1615595819960() {
        this.name = 'InitialAgain1615595819960';
    }
    InitialAgain1615595819960.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE \"cart_line\" ADD CONSTRAINT \"FK_e4ebe82255b564027ae01acd239\" FOREIGN KEY (\"cartId\") REFERENCES \"cart\"(\"id\") ON DELETE CASCADE ON UPDATE NO ACTION")];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    InitialAgain1615595819960.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE \"cart_line\" DROP CONSTRAINT \"FK_e4ebe82255b564027ae01acd239\"")];
    ...
    return InitialAgain1615595819960;
}());
