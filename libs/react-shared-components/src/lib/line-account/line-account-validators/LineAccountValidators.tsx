    ...
    <>
      <Badge {...badgeAttribs}>
        <HStack>
          ...
          <Text
            data-testid="lineAccountTotalPercentages"
            ml={2}
            fontWeight="bolder"
          >
            {getTotalPercentages(line)}%
          </Text>
        </HStack>
      </Badge>
      <Badge {...badgeAttribs}>
        <HStack>
          ...
          <Text data-testid="lineAccountLineTotal" ml={2} fontWeight="bolder">
            {toFriendlyCurrency(getTotalAmounts(line.cartLineAccounts))}
          </Text>
        </HStack>
      </Badge>
    </>
